...
output += '          <input type="text" id="project-name" name="project-name" class="form-control proj-input" value="' + Blockscad.Msg.PROJECT_NAME_DEFAULT + '" maxlength="28" style="width: 300px;">\n';
output += '        </div>\n';
...
output += '                    <button type="button" class="btn btn-default btn-lg changeable" id="printButton">Save As STL</button>\n';
output += '                  </div>\n';
